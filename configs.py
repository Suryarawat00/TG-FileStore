...
class Config(object):
	...
	DB_CHANNEL = int(os.environ.get("DB_CHANNEL", "-1002153603252"))
	BOT_OWNER = int(os.environ.get("BOT_OWNER", "1906280172"))
	DATABASE_URL = os.environ.get("DATABASE_URL")
	UPDATES_CHANNEL = os.environ.get("UPDATES_CHANNEL", "-1001547484170")
